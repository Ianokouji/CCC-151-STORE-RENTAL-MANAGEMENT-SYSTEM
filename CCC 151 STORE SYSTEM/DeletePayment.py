...
class DeletePaymentsDialog(QDialog):
    def __init__(self, message, parent=None):
        super().__init__(parent)
        self.setWindowTitle("Delete Payment Confirmation")
        ...
        # Title label
        title_label = QLabel("Delete Payment")
        ...
        delete_button.setObjectName("DeleteB")
        delete_button.setFont(label_font)
